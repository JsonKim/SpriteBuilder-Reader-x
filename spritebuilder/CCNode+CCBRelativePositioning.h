...
extern cocos2d::Point getAbsolutePosition(cocos2d::Point pt, CCBReader::PositionType type, CCBReader::PositionUnit xUnit, CCBReader::PositionUnit yUnit, const cocos2d::Size &containerSize, const char *propName);
