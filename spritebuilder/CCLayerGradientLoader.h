#ifndef _SB_CCLAYERGRADIENTLOADER_H_
#define _SB_CCLAYERGRADIENTLOADER_H_
...
public:
    ...
    SB_STATIC_NEW_AUTORELEASE_OBJECT_METHOD(LayerGradientLoader, loader);

protected:
    SB_VIRTUAL_NEW_AUTORELEASE_CREATECCNODE_METHOD(cocos2d::LayerGradient);
